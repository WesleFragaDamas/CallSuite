"""
Django settings for callsuite project.
...
SECRET_KEY = 'django-insecure--rk-jpkqdh#h%gu0!l(jlu-6lx-hv&mzxipn3f4+9s$h&sq1^r'
...
WSGI_APPLICATION = 'callsuite.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'callsuite_db',        # O nome do banco que você criou
        'USER': 'postgres',       # O usuário que você criou
        'PASSWORD': '88124737', # A senha que você definiu
        'HOST': 'localhost',            # Ou o IP do servidor do banco, se não for local
        'PORT': '5432',
    }
}
